...
db.Libros.insertMany([
    ...
    { titulo: "La Amistad", fecha_publicacion: ISODate("2002-01-01"), sinopsis: "Una obra de Alfredo Bryce Echenique que explora las relaciones personales y la vida cotidiana de un hombre que busca un sentido en su existencia.", disponibilidad: true, paginas: 330, generos: ["Ficción", "Drama"], autores: ["Alfredo Bryce Echenique"]},
    { titulo: "El Huésped", fecha_publicacion: ISODate("2001-01-01"), sinopsis: "Una novela de Alfredo Bryce Echenique sobre un hombre que trata de comprender la soledad y las conexiones humanas en un mundo cada vez más alienante.", disponibilidad: true, paginas: 290, generos: ["Ficción", "Drama"], autores: ["Alfredo Bryce Echenique"]},
...
db.Usuarios.insertMany([
    { nombre: "Rodrigo", apellido_paterno: "Infanzón", apellido_materno: "Acosta", "telefono": "987654321", direccion: "Av. Principal 123, Lima", clave: "admin", fecha_nacimiento: ISODate("2004-04-16") },
    { nombre: "Daniel", apellido_paterno: "Aguilar", apellido_materno: "Chirinos", "telefono": "987654322", direccion: "Calle Secundaria 456, Lima", clave: "admin", fecha_nacimiento: ISODate("2004-04-16") }
]);